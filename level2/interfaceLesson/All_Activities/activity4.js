  ...
  let All_choose_mob=document.querySelectorAll(".Responsive-mob .choose-item-content")
    ...
    document.querySelector(".finish").onclick=function(event)
    {
        ...
        for (let i=1;i<=All_input.length;i++)
        {
            ...
            if (document.getElementsByTagName("input")[i-1].checked )
            {
                 ...
                 else
                {
                    ...
                    {
                         AllTd_not=document.querySelectorAll(`.not-father${count_notFather} table th`)
        ...
        if (sum>=numberQuestion/2)       
       {
        document.querySelector(".Responsive-lab .Description").style.display="block";
            ...
            let AllTd=document.querySelectorAll(".father2 table th")
            for (let i=1;i<=y;i++)
          {
      ...
      document.querySelector(".Responsive-lab .back").onclick=function()
    {   
        ...
        for (let i=1;i<=All_input.length;i++)
        {
            ...
            if (document.getElementsByClassName("in")[i-1].checked )
            {
                ...
                else
                {
                    ...
                    if (count_notFather===4 || count_notFather===5 || count_notFather===6)
                    {
                         AllTd_not=document.querySelectorAll(`.Responsive-mob .not-father${count_notFather} table th`)
                        console.log(AllTd_not)
                        for (let k=0;k<AllTd_not.length;k++)
                        {
                            AllTd_not[k].style.border="4px solid #E71D36"
    ...
    {   
      ...
      document.querySelector(".Responsive-mob .overlie").style.opacity="0";
       let AllTd=document.querySelectorAll(".Responsive-mob .father2 table th")
            for (let i=1;i<=y;i++)
          {
            ...
            {
            document.querySelector(".Responsive-mob .father"+i).style.border="4px solid #78C04C"
            }
          }
    }
